            ...
            <main className="flex-1 flex flex-col max-h-screen">
                ...
                >
                    ...
                    <img
                        src={
                            receiver.avatar ||
                            `https://ui-avatars.com/api/?name=${receiver.first_name}+${receiver.last_name}&background=random`
                        }
                    ...
                    {messages && typeof (messages) === 'object' && messages.map((message, index) => (
                        <Fragment key={index}>
                            {message.sender !== receiver._id ? (
                                <div className="flex justify-end sender">
                                    <div className="bg-teal-900 rounded-xl px-3 py-2 break-words">
                                        <p>{message.content}</p>
                                ...
                                <div className="flex justify-start receiver">
                                    <div className="bg-gray-700 rounded-xl px-3 py-2 break-words">
                                        <p>{message.content}</p>
                ...
                {/* Reply Section */}
                <form
                    className="bg-gray-900 px-4 mt-2 mb-4 border-gray-700"
                    action={handleSubmit}
                >
